...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.fzS6Lyj'] ?? $container->get_ServiceLocator_FzS6LyjService()), ($container->privates['.service_locator.ki1b2dW'] ?? $container->load('get_ServiceLocator_Ki1b2dWService')), ['userapp' => [0 => ($container->privates['App\\Security\\AppUserAuthenticator'] ?? $container->load('getAppUserAuthenticatorService')), 1 => ($container->privates['security.authenticator.form_login.userapp'] ?? $container->load('getSecurity_Authenticator_FormLogin_UserappService'))]], true);
