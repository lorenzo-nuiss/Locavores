 ...
 */
class getSecurity_Firewall_Map_Context_UserappService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.firewall.map.context.userapp' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.firewall.map.context.userapp'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['security.firewall.authenticator.userapp'] ?? $container->load('getSecurity_Firewall_Authenticator_UserappService'));
            yield 3 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($container->privates['security.authentication.trust_resolver'] ?? ($container->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), $b, 'userapp', ($container->privates['security.authenticator.form_login.userapp'] ?? $container->load('getSecurity_Authenticator_FormLogin_UserappService')), NULL, NULL, ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, ($container->privates['security.event_dispatcher.userapp'] ?? $container->getSecurity_EventDispatcher_UserappService()), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('userapp', 'App\\Security\\EmailValidateChecker', NULL, true, false, 'security.user.provider.concrete.all_users', 'userapp', 'security.authenticator.form_login.userapp', NULL, NULL, [0 => 'custom_authenticators', 1 => 'form_login'], NULL), ($container->privates['security.untracked_token_storage'] ?? ($container->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())));
    }
}
