...
class __TwigTemplate_823260ec8212ed08ea8b0492ed586b06185f133f39c6f8157e4add4059c2fdd0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "flashes", [0 => "reset_password_error"], "method", false, false, false, 13));
    ...
    {
        return array (  168 => 31,  154 => 20,  150 => 19,  145 => 16,  136 => 14,  132 => 13,  129 => 12,  119 => 11,  104 => 39,  98 => 35,  96 => 11,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %}Locavor - Réinitialisez votre mot de passe{% endblock %}
...
<div class=\"col\">
<img class=\"radius\" src=\"{{ asset('/images/Producteur-qui-se-pose-questions-site.jpg') }}\" alt=\"Illustration mot de passe perdu\">
</div>
</section>
</main>
{% endblock %}
", "reset_password/request.html.twig", "C:\\code\\xamp\\htdocs\\Locavores\\templates\\reset_password\\request.html.twig");
    }
}
