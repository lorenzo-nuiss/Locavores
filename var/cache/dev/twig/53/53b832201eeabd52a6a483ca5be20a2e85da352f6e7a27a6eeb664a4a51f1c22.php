...
class __TwigTemplate_4fa864dcf405315500e5e8b4d52183c0211c3785ff9ff164913839da0e6de848 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  133 => 22,  127 => 19,  122 => 17,  116 => 13,  106 => 12,  90 => 5,  80 => 4,  60 => 2,  37 => 1,);
    }
...
<div class=\"text-center my-md-4\">
    ...
    <h1 class=\"fw-bold\">Oups !</h1>
    <h2 class=\"fw-bold status\">{{ status_code }}</h2>
    <p>
        Une erreur s'est produite : {{ status_text }} .
    </p>

        <a href=\"{{ path('home') }}\" class=\"btn btn1 mt-4\">Retourner à l'accueil</a>
</div>
</main>
{% endblock %}", "@Twig/Exception/error.html.twig", "C:\\code\\xamp\\htdocs\\Locavores\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
