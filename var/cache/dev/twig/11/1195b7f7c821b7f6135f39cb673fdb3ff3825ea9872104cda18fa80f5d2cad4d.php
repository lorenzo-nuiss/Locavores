...
class __TwigTemplate_259bf4a7f1f5965b761e8c8ec56a5b8a61122794042305b8bf0c69a95652fe17 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        // line 44
        echo "\t\t\t\t";
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 44, $this->source); })()), "user", [], "any", false, false, false, 44), "disponible", [], "any", false, false, false, 44) == false)) {
            // line 45
